			...
			<div class="container">
				<div class="row row-pb-md">
					<div class="col-md-3 colorlib-widget">
						<h4>About Daniel Creative School</h4>
						<p>DCS (Daniel Creative School) merupakan salah satu Sekolah Menegah Atas di Semarang, Jawa Tengah. Dengan naungan dibawah Kementerian Pendidikan dan Kebudayaan, DCS merupakan salah satu Sekolah ternama di Semarang. DCS berdiri pada tanggal 26 Desember 2016 dengan nomor SK. Pendirian 29/YPK-KAO/GM/VIII/2011</p>
						<p>
					...
					<div class="col-md-3 colorlib-widget">
						...
						<p>
							<ul class="colorlib-footer-links">
								...
								<li><a href="<?php echo base_url().'web/pendaftaran'?>"><i class="icon-check"></i> Courses</a></li>
								<li><a href="<?php echo base_url().'web/news'?>"><i class="icon-check"></i> News</a></li>
								<li><a href="<?php echo base_url().'web/contact'?>"><i class="icon-check"></i> Contact</a></li>
							</ul>
						</p>
					</div>
					...
					<div class="col-md-3 colorlib-widget">
					  <h4>Contact Info</h4>
						<ul class="colorlib-footer-links">
							...
							<p>Puri Anjasmoro Blok J1 No.10A, Semarang, Jawa Tengah </p>
							<li><a href="tel://1234567920"><i class="icon-phone"></i></a><a href="tel://087733800021">(024) 762.2444</a></li>
							<li><a href="mailto:info@yoursite.com"><i class="icon-envelope"></i></a><a href="mailto:info@Swela.com">dcsinfo[at]</a><a href="mailto:info@Swela.com">danielcreativeschool.com</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center">
							<p>
								<small class="block">&copy; <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->DCS &copy; Daniel Creative School | Jadilah orang yang BERMANFAAT <i class="icon-heart" aria-hidden="true"></i> <a href="https://colorlib.com" target="_blank"></a>
