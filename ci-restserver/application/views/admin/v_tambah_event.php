...
<div id="main">
        <h4>Tambah event</h4>
        <?php echo form_open_multipart('admin/tambah_event')?>
        ...
        <!-- <form class="contact_form" action="" method=""> -->
            <ul>
                ...
                <li>
                    ...
                    <input name="penyelenggara" type="text" placeholder="">
                    <!-- <span class="form_hint">example "http://someaddress.com"</span> -->
                </li>
                <li>
                    <label for="nama_event">Nama_event :</label>
                    <input name="nama_event" type="text" placeholder="">
                </li>
                <li>
                    <label for="tempat">Tempat :</label>
                    <input name="tempat" type="text" placeholder="">
                    <!-- <span class="form_hint">example "http://someaddress.com"</span> -->
                </li>
                <li>
