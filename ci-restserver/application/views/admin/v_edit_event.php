...
<div id="main">
        <h4>Tambah Berita</h4>
        <?php echo form_open_multipart('admin/event_edit_in')?>
        ...
        <!-- <form class="contact_form" action="" method=""> -->
            <ul>
                ...
                <li>
                    ...
                    <input name="penyelenggara" type="text" placeholder="" value="<?php echo $record['penyelenggara'] ?>">
                    <!-- <span class="form_hint">example "http://someaddress.com"</span> -->
                </li>
                <li>
                    <label for="nama_event">Nama Event :</label>
                    <input name="nama_event" type="text" value="<?php echo $record['nama_event'] ?>" placeholder="">
                </li>
                <li>
                    <label for="tempat">Tempat :</label>
                    <input name="tempat" type="text" value="<?php echo $record['tempat'] ?>" placeholder="">
                    <!-- <span class="form_hint">example "http://someaddress.com"</span> -->
                </li>
                <li>
