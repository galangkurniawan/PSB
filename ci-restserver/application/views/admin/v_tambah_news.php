...
<div id="main">
        <h4>Tambah Berita</h4>
        <?php echo form_open_multipart('admin/tambah_news')?>
        ...
        <!-- <form class="contact_form" action="" method=""> -->
            <ul>
                ...
                <li>
                    ...
                    <input name="judul" type="text" placeholder="">
                    <!-- <span class="form_hint">example "http://someaddress.com"</span> -->
                </li>
                <li>
                    <label for="isi">Isi Berita :</label>
                    <textarea name="isi" cols="40" rows="6" required></textarea>
                </li>
                <li>
                    <label for="sumber">sumber</label>
                    <input name="sumber" type="text" placeholder="">
                    <!-- <span class="form_hint">example "http://someaddress.com"</span> -->
                </li>
                <li>
