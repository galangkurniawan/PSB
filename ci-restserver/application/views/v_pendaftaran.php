        ...
        <!-- <form class="contact_form" action="" method=""> -->
            <ul>
                ...
                <li>
                    ...
                    <textarea name="alamat" cols="40" rows="6" placeholder="Alamat" required=""></textarea>
                </li>
                <li>
                    <label for="asal_sekolah">Asal sekolah</label>
                    <input name="asal_sekolah" type="text" placeholder="Asal Sekolah (HURUF BESAR SEMUA)" required="">
                    <!-- <span class="form_hint">example "http://someaddress.com"</span> -->
                </li>
                <li>
                    <label for="no_hp">Nomer Telepon</label>
                    <input name="no_hp" type="text" placeholder="Yang digunakan pada WhatsApp" required="">
                    <!-- <span class="form_hint">example "http://someaddress.com"</span> -->
                </li>
                <li>
                    <label for="nem">Nem</label>
                    <input name="nem" type="text" placeholder="Nilau UN Anda" required="">
                    <!-- <span class="form_hint">example "http://someaddress.com"</span> -->
                </li>
                <li>
                ...
                <li>
                    ...
                    <input name="password" type="password" placeholder="Password.." minlength="6" maxlength="10">
                </li>
                <li>
                    <label for="password1">Password *</label>
                    <input name="password1" type="password" placeholder="Konfirm Password" minlength="6" maxlength="10">
