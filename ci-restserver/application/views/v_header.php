		...
		<nav class="colorlib-nav" role="navigation">
			...
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-md-2">
							<div id="colorlib-logo"><a href="<?php echo base_url().'web/index' ?>"> DCS</a></div>
						</div>
			   	...
			   	<li style="background-image: url(<?php echo base_url() ?>assets/images/img_bg_3.jpg);">
			   		...
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Pendidikan adalah kunci kesuksesan</h1>
				   					<p><a href="<?php echo base_url().'web/pendaftaran' ?>" class="btn btn-primary btn-lg btn-learn">Register Now</a></p>
				   				</div>
				   			</div>
				   		</div>
